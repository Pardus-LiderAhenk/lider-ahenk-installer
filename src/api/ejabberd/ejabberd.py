...
class EjabberInstaller(object):
    ...
    def install(self, data):
        ...
        if self.ssh_status == "Successfully Authenticated":
            ...
            result_code = self.ssh_api.run_command(self.cmd_register.format(self.cmd_bin_ejabberd_path, data["e_username"], data["e_service_name"], data["e_user_pwd"]))
            if result_code == 0:
            ...
            result_code = self.ssh_api.run_command(self.cmd_register.format(self.cmd_bin_ejabberd_path, data["lider_username"], data["e_service_name"], data["lider_user_pwd"]))
            if result_code == 0:
